...
window.onload = function(){
  document.getElementById('fileInput').addEventListener('change', function () {
    if (this.files && this.files[0]) {
     ...
     //var model_viewertag = '<model-viewer ar src="NewModem.glb" shadow-intensity="1" auto-rotate camera-controls alt="" ar-scale="auto" ios-src="Models/1Modem.usdz"></model-viewer>'
